...
result.unshift('');re.lastIndex=savedIndex;return result;});var Functional=this.Functional||{};Functional.install=function(except){var source=Functional,target=(function(){return this;})();for(var name in source)
name=='install'||name.charAt(0)=='_'||except&&name in except||!source.hasOwnProperty(name)||(target[name]=source[name]);}
...
Function.prototype.traced=function(name){var self=this,global=(function(){return this;})(),log=function(){};if(typeof console!='undefined'&&typeof console.info=='function'){log=console.info;}else if(typeof print=='function'){log=print;}
name=name||self;return function(){log('[',name,'apply(',this!=global&&this,',',arguments,')');var result=self.apply(this,arguments);log(']',name,' -> ',result);return result;}}
